    ...
    extend: {
      colors: {
        ...
        widget: {
          ...
          inspiration: "hsl(var(--widget-inspiration))",
          routine: "hsl(var(--widget-routine))",
          notes: "hsl(var(--widget-notes))",
          quiz: "hsl(var(--widget-quiz))",
          profile: "hsl(var(--widget-profile))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      backgroundImage: {
        ...
        'gradient-inspiration': 'var(--gradient-inspiration)',
        'gradient-routine': 'var(--gradient-routine)',
